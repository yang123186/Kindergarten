...
static NSString * const reuseIdentifier = @"FlowerListCell";

- (void)viewDidLoad {
    [super viewDidLoad];
    [self.collectionView registerClass:[CommonCollectionCell class] forCellWithReuseIdentifier:reuseIdentifier];
}
